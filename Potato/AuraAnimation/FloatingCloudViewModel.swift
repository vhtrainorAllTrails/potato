...
struct FloatingCloudViewModel {
    static let nightPalette = ColorPalette(title: "Night", colors: WeatherColors.night)
    static let rainyPalette = ColorPalette(title: "Rainy", colors: WeatherColors.rainy)
    static let dayPalette = ColorPalette(title: "Day", colors: WeatherColors.day)
    ...
    struct WeatherColors {
        static let night = [Color(red: 0.0, green: 0.0, blue: 0.0),
                            ...
                            Color(red: 0.2, green: 0.21, blue: 0.61, opacity: 0.78),
        ]
        
        static let rainy = [Color(red: 0.61, green: 0.77, blue: 0.9, opacity: 0.4),
